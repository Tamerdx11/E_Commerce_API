    ...
    : IDbInitializer
{
    public async Task InitializeAsync()
    {
        try
        {
            ...
            {
                var brandData = await File.ReadAllBytesAsync(@"..\Infrastructure\E-Commerce.Persistance\Context\DataSeed\brands.json");
            ...
            {
                var typesData = await File.ReadAllBytesAsync(@"..\Infrastructure\E-Commerce.Persistance\Context\DataSeed\types.json");
            ...
            {
                var productsData = await File.ReadAllBytesAsync(@"..\Infrastructure\E-Commerce.Persistance\Context\DataSeed\products.json");
